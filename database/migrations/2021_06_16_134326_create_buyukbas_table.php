...
class CreateBuyukbasTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('buyukbas', function (Blueprint $table) {
            $table->id();
            ...
            $table->integer('referans')->default(8);
